...
with torch.no_grad():
    samples = torch.randn(11, 10).to(trainer.device)
...
print("pick one image", images[0].shape)
display_images_in_a_row(images[0], file_path='./tmp0.png', display=True)
print("pick another one image", images[12].shape)
display_images_in_a_row(images[12], file_path='./tmp1.png', display=True)
